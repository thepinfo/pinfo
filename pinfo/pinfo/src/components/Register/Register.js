  	...
  	return (
          ...
          <form className="measure">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              <div className="f4 fw6 ph0 mh0">Sign Up</div>
              <div className="mt3">
                <label className="db fw6 lh-copy f6" for="fname">First Name</label>
                <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="text" name="fname"  id="fname" />
              </div>
              <div className="mt3">
                <label className="db fw6 lh-copy f6" for="lname">Last Name</label>
