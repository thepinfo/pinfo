                ...
                { this.state.loaded &&
                   /* 
                    <br/>
                      ...
                      */                      
                      rows.map((row, i) => {                        
                          return <div className='equalHMR eq artistwcontrol r3 ba b--black-10 mv2 shadow-5 center inline artistcard' id='artistcard' value={row.artist} onClick={((e) => this.handleClick(e, row))} key={i}>
